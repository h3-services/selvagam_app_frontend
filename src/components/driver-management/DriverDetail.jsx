            ...
            <div className="relative p-8 border-b border-blue-100 bg-gradient-to-br from-blue-50 to-white">
                <div className="flex items-center justify-between gap-6">
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <h2 className="text-3xl font-bold tracking-tight" style={{ color: '#3A7BFF' }}>Driver Profile</h2>
                    ...
                    <div className="flex gap-3">
                        {isEditing ? (
                            ...
                            <button onClick={() => setIsEditing(true)} className="px-6 py-2.5 text-white rounded-xl hover:shadow-lg transition-all text-sm font-bold flex items-center gap-2" style={{ backgroundColor: '#3A7BFF' }}>
                ...
                <div className="flex flex-col lg:flex-row gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="w-full lg:w-1/3 flex flex-col gap-8">
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border-2 border-blue-50 p-8 flex flex-col items-center text-center relative overflow-hidden group hover:border-blue-100 transition-all">
                            ...
                            <div className="relative z-10 w-28 h-28 rounded-3xl border-4 border-white shadow-xl overflow-hidden bg-blue-50 mb-6 flex items-center justify-center">
                                {isEditing ? (
                                    <div className="flex flex-col justify-center h-full w-full bg-blue-50 p-2">
                                        <input
                                            type="text"
                                            placeholder="Photo URL"
                                            value={editData?.photo_url || ''}
                                            onChange={(e) => setEditData({ ...editData, photo_url: e.target.value })}
                                            className="text-xs p-2 text-center bg-white rounded-lg outline-none w-full border border-blue-100"
                                        />
                                    </div>
                                ) : (
                                    selectedDriver.photo_url ? (
                                        ...
                                        <div className="w-full h-full flex items-center justify-center text-4xl font-bold text-[#3A7BFF]">
                            ...
                            {isEditing ? (
                                ...
                                <h3 className="text-2xl font-black text-[#3A7BFF] mb-2 relative z-10">{selectedDriver.name}</h3>
                            )}
                                ...
                                {isEditing ? (
                                    ...
                                    <>
                                        <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider border ${
                                            selectedDriver.status === 'Active' ? 'bg-green-50 text-green-600 border-green-200' : 
                                            selectedDriver.status === 'Resigned' ? 'bg-red-50 text-red-600 border-red-100' :
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border-2 border-blue-50 p-8">
                            ...
                            <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl border border-gray-100 group hover:border-purple-200 transition-all">
                                ...
                                {isEditing && (
                                    <div className="cursor-pointer text-3xl text-[#3A7BFF] hover:scale-110 transition-transform" onClick={() => setEditData({ ...editData, is_available: !editData.is_available })}>
                    ...
                    <div className="w-full lg:w-2/3 flex flex-col gap-8">
                        ...
                        <div className="bg-white rounded-[32px] shadow-sm border-2 border-blue-50 p-8 relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
                                ...
                                <div className="flex items-center gap-3 p-3 border-b border-gray-100 last:border-0 md:border-0 hover:bg-blue-50 rounded-lg transition-colors">
                                    <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-[#3A7BFF] shrink-0">
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {isEditing ? (
                                            <input
                                                ...
                                                className="w-full mt-1 px-2 py-1 text-sm border-b border-purple-200 focus:border-[#3A7BFF] outline-none bg-transparent"
                                            />
                                        ) : (
                                ...
                                <div className="flex items-center gap-3 p-3 hover:bg-blue-50 rounded-lg transition-colors border-b border-gray-100 md:border-b-0">
                                    <div className="w-8 h-8 rounded-full bg-blue-50 flex items-center justify-center text-[#3A7BFF] shrink-0">
